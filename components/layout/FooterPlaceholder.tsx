...
const socialLinks = [
  {
    ...
    href: "#",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="size-4 lg:size-5">
              ...
              {socialLinks.map((social) => (
                <li key={social.label}>
                  <a
                    ...
                    className="inline-flex size-8 items-center justify-center text-[#0A2540] transition-colors hover:text-primary lg:size-10"
                  >
                    {social.icon}
                  </a>
                </li>
