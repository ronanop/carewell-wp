...
export type MedicalEvidenceSectionProps = SectionBaseProps & {
  /** CMS: evidence.eyebrow */
  eyebrow?: string;
  /** CMS: evidence.heading */
  title?: string;
  /** CMS: evidence.intro */
  intro?: string;
  /** CMS: evidence.items */
...
export function MedicalEvidenceSection({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(720px_180px_at_50%_0%,rgba(21,87,160,0.08),transparent_58%)]"
        aria-hidden
      />
            ...
            {list.map((item, i) => (
              <li
                ...
                className={cn(
                  ...
                  "border-l-[3px] border-l-[#1557A0]",
                  "transition-colors duration-200 hover:border-[#1557A0]/30 hover:border-l-[#1557A0]",
              ...
              >
                ...
                <div className="min-w-0 pt-0.5">
                  <p className="text-[0.625rem] font-semibold tracking-[0.12em] text-[#1557A0]/80 uppercase">
