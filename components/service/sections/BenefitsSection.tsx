...
export type BenefitsSectionProps = SectionBaseProps & {
  /** CMS: benefits.eyebrow */
  eyebrow?: string;
  /** CMS: benefits.heading */
  title?: string;
  /** CMS: benefits.intro */
  intro?: string;
  /** CMS: benefits.items */
...
/**
 * Treatment benefits / what patients gain.
...
export function BenefitsSection({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(700px_160px_at_85%_0%,rgba(21,87,160,0.07),transparent_55%)]"
        aria-hidden
      />
