...
export type CausesSectionProps = SectionBaseProps & {
  /** CMS: causes.eyebrow */
  eyebrow?: string;
  /** CMS: causes.heading */
  title?: string;
...
/**
 * Causes & risk factors — check-list cards on muted brand band.
 * Shares Symptoms visual language (band, header, cards); check icons vs numbers.
