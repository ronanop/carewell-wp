...
export type DiagnosisSectionProps = SectionBaseProps & {
  /** CMS: diagnosis.eyebrow */
  eyebrow?: string;
  /** CMS: diagnosis.heading */
  title?: string;
  /** CMS: diagnosis.intro */
  intro?: string;
  /** CMS: diagnosis.items */
...
/**
 * Diagnosis / evaluation checklist.
...
export function DiagnosisSection({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(700px_160px_at_15%_0%,rgba(21,87,160,0.07),transparent_55%)]"
        aria-hidden
      />
