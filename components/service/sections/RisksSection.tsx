...
export type RisksSectionProps = SectionBaseProps & {
  /** CMS: risks.eyebrow */
  eyebrow?: string;
  /** CMS: risks.heading */
  title?: string;
...
/**
 * Risks & side effects — calm, transparent list (not alarmist).
...
export function RisksSection({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(640px_140px_at_12%_0%,rgba(217,119,6,0.05),transparent_50%),radial-gradient(700px_160px_at_88%_0%,rgba(21,87,160,0.06),transparent_55%)]"
        aria-hidden
      />
          ...
          <ul className="grid gap-3 sm:grid-cols-2 sm:gap-4">
            {list.map((item, i) => (
              <li
                ...
                className={cn(
                  "flex gap-3.5 rounded-2xl border border-slate-200/90 border-l-[3px] border-l-amber-400/70 bg-white p-4 sm:p-5",
                  "shadow-[0_8px_28px_-18px_rgba(10,46,82,0.28)]",
                  "transition-colors duration-200 hover:border-[#1557A0]/25 hover:border-l-amber-500/80",
