...
export function BlogTableOfContents({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 border-b border-border/70 bg-surface/60 px-5 py-3.5 sm:px-6">
        <span className="flex size-8 items-center justify-center rounded-lg bg-primary/10 text-primary">
          <List className="size-4" aria-hidden />
        </span>
        <h2
          id="blog-toc-heading"
          className="font-heading text-base font-semibold text-[#0A2540] sm:text-lg"
        >
          Table of contents
        </h2>
      </div>
