    ...
    <section className="bg-background" aria-labelledby="qualifications-heading">
      <div className="container-content section-padding">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-label uppercase text-[#3B82F6]">Credentials</p>
          <h2
        ...
        <ol className="relative mx-auto mt-12 max-w-3xl space-y-0">
          {items.map((item, index) => (
            <li key={item.title} className="relative flex gap-5 pb-10 last:pb-0">
              <div className="flex flex-col items-center">
                <span className="flex size-3 shrink-0 rounded-full bg-[#3B82F6] ring-4 ring-[#3B82F6]/15" />
